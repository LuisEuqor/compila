...
# Creamos nuestro AFD para operadores 
AFD_OPERADOR = {
    "q0": {OPERADOR: "q1"},
    "q1": {LETRA: "q1",DIGITO: "q1","default": "q2"},
    "q2": {}
...
def analizador_lexico(cadena):
    ...
    for caracter in cadena:
        if caracter.isdigit():
            ...
            if estado_actual in AFD_OPERADOR and LETRA and DIGITO in AFD_OPERADOR[estado_actual]:
                estado_actual = AFD_OPERADOR[estado_actual][OPERADOR]
                token_actual += caracter
            else:
                tokens.append(token_actual)
                token_actual = caracter
            ...
            if estado_actual in AFD_NUM_ENTERO:
                ...
                token_actual = ""
                estado_actual = "q0"
            elif estado_actual in AFD_OPERADOR:
                tokens.append(token_actual)
                token_actual = ""
                estado_actual = "q0"
